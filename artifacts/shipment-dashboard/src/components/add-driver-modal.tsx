...
export function AddDriverModal({ open, onOpenChange, onSuccess }: AddDriverModalProps) {
  ...
  function onSubmit(data: AddDriverFormValues) {
    ...
    toast.success("Driver added successfully", {
      description: `Driver ${data.name} has been registered`,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Register a new driver for dispatches.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
          ...
          >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g. +966 50 123 4567" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="flex justify-end pt-2">
              <Button type="submit" className="min-w-[100px]">Save Driver</Button>
            </div>
          </form>
        </Form>
      </DialogContent>
...
export function AddDriverButton({ onSuccess }: { onSuccess?: (name: string) => void }) {
